...
<div align="center">
  ...
  <img src="./book.png" alt="logo" width="140"  height="auto" />
  <br/>
...
```sh
git clone https://github.com/HunterX-7/OOP-School-Library.git
```
...
Feel free to check the [issues page](https://github.com/HunterX-7/OOP-School-Library/issues).
